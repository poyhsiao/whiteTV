  ...
  group('Search Feature BDD Tests', () {
    ...
    group('Category Filter Flow', () {
      testWidgets(
        ...
        'Then all category options should be visible',
        (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: Scaffold(
      ...
      testWidgets(
        'Given the search store has a selected category '
    ...
    group('Search Results Flow', () {
      testWidgets(
        'Given the search has completed '
      ...
      testWidgets(
        'Given the search has completed with no results '
    ...
    group('Keyboard Mode Flow', () {
      testWidgets(
        'Given the search store has keyboard mode disabled '
        'When toggleKeyboardMode is called '
        'Then the keyboard mode should be enabled',
        (tester) async {
          final store = SearchStore(MockClient());
      ...
      testWidgets(
        'Given the keyboard mode is enabled '
      ...
      testWidgets(
        ...
        'Then a space character should be sent',
        (tester) async {
          String? pressedKey;
      ...
      testWidgets(
        ...
        'Then a backspace character should be sent',
        (tester) async {
          String? pressedKey;
    ...
    group('QR Scan Flow', () {
      testWidgets(
        'Given the QR scanner is displayed '
        'When the camera permission is denied '
        'Then a permission denied message should be shown',
        (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: Scaffold(
          ...
          expect(find.text('Please enable camera access in settings'), findsOneWidget);
        },
      );

      testWidgets(
        'Given the QR scanner has detected a code '
    ...
    group('History Flow', () {
      ...
      testWidgets(
        'Given the SearchHistoryService has duplicate searches '
      ...
      testWidgets(
        'Given the SearchHistoryService has reached max items '
        'When a new search is saved '
        'Then the oldest search should be removed',
        (tester) async {
          SharedPreferences.setMockInitialValues({});
          final prefs = await SharedPreferences.getInstance();
          final service = SearchHistoryService(prefs, MockClient());
      ...
      testWidgets(
        'Given the user wants to clear history '
      ...
      testWidgets(
        'Given the SearchHistoryService '
      ...
      test(
        'Given the SearchStore has performed searches '
        'When clearSearch is called '
        'Then the current query should be added to history',
        () async {
          final store = SearchStore(MockClient());
    ...
    group('Error Handling Flow', () {
      ...
      test(
        'Given the search store is initialized '
        'When a search is performed '
        'Then the loading state should be set during the search',
        () async {
          final store = SearchStore(MockClient());
    ...
    group('SearchStore State Management', () {
      test(
        'Given the SearchStore is initialized '
      ...
      test(
        'Given the SearchStore has performed a search '
        'When the search method is called '
        'Then the query should be updated in state',
        () async {
          final store = SearchStore(MockClient());
      ...
      test(
        'Given the SearchStore has keyboard mode enabled '
        'When toggleKeyboardMode is called '
      ...
      test(
        'Given the SearchStore has results '
        'When clearSearch is called '
        'Then the query and results should be cleared',
        () async {
          final store = SearchStore(MockClient());
